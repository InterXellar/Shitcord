...
latex_documents = [
    (master_doc, 'Shitcord.tex', 'Shitcord Documentation',
     'Valentin B.', 'manual'),
]
...
man_pages = [
    (master_doc, 'shitcord', 'Shitcord Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Shitcord', 'Shitcord Documentation',
     author, 'Shitcord', 'One line description of project.',
     'Miscellaneous'),
]
